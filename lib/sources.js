(function (root) {
  ...
  ns.ChromeStore = function (options) {
    this.name = options.name;
  };

  ns.ChromeStore.prototype = _.extend(new ns.EgoSource(), {
    constructor: ns.ChromeStore,
    API_URL: '/chrome_web_store.json',
    ICON_URL: 'https://www.google.com/images/icons/product/chrome_web_store-16.png',
    LINK_URL: 'https://chrome.google.com/webstore/detail/ddldimidiliclngjipajmjjiakhbcohn',
    jsonURL: function () {
      return this.API_URL;
    },
    linkURL: function () {
